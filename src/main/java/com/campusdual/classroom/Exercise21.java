...
public class Exercise21 {
    ...
    public static void main(String[] args) {
            ...
            String anadido = "ELEMENT AAA";

            System.out.println("\nHashSet antes:\n");
            printSet(hashSet);
            boolean hashSetResult = addElementToSet(hashSet, anadido);
            System.out.println("\nAñadido a HashSet: " + hashSetResult);
            System.out.println("\nHashSet despues:\n");
            printSet(hashSet);

            System.out.println("\nTreeSet antes:\n");
            printSet(treeSet);
            boolean treeSetResult = addElementToSet(treeSet, anadido);
            System.out.println("\nAñadido a TreeSet: " + treeSetResult);
            System.out.println("\nTreeSet despues:\n");
            printSet(treeSet);
    }
